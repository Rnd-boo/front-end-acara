  ...
  return (
    <div className="flex flex-col items-center justify-between bg-slate-900 px-6 py-10 text-center lg:flex-row lg:text-left xl:p-20">
      ...
      <div className="mb-4 flex flex-col gap-4 lg:mb-0">
        <div>
          <h4 className="text-xl text-white">CustomerServices</h4>
          <p className="text-gray-600">
            <Link href="mailto:hello@acara.id">hello@acara.id</Link> |{" "}
            <Link href="tel:+62123123123">+62 1234 1234 123</Link>
          </p>
        </div>
      </div>
      <div className="mb-4 flex flex-col gap-4 lg:mb-0">
        <div>
          ...
          <p className="text-gray-600">JL.Sumarsonoujung 925,medan</p>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center gap-8">
        ...
        <p className="w-full text-center text-gray-600">
          Copyright c 2025 Acara. All right reserve
        </p>
      </div>
    </div>
  );
