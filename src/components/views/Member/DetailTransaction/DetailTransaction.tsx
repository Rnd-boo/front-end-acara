...
const DetailTransaction = () => {
  const { dataEvent, dataTransaction, dataTicket } = useDetailTransaction();
  return (
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="mt-2 flex flex-col gap-4">
              {dataTransaction?.vouchers.map(
                (voucher: { vocuherId: string }) => (
                  <Card
                    shadow="sm"
                    className="p-4 pt-6 lg:p-2"
                    key={`voucher-${voucher.vocuherId}`}
                  >
                    <CardBody className="gap-8 lg:flex-col">
                      <div className="mx-auto mb-4 w-2/3 lg:m-0 lg:w-1/5">
                        <QRCodeSVG
                          value={voucher.vocuherId}
